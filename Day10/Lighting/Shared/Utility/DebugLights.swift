...
enum DebugLights {
  ...
  static func debugDrawPoint(encoder: MTLRenderCommandEncoder,
                             uniforms: Uniforms,
                             position: float3,
                             color: float3) {
  ...
  static func debugDrawDirection(renderEncoder: MTLRenderCommandEncoder,
                                 uniforms: Uniforms,
                                 direction: float3,
                                 color: float3,
                                 count: Int) {
  ...
  static func debugDrawLine(renderEncoder: MTLRenderCommandEncoder,
                            uniforms: Uniforms,
                            position: float3,
                            direction: float3,
                            color: float3) {
